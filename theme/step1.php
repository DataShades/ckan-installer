<div class="module-content">
  ...
  <form method="post" name="form-name">
    ...
    <!--  Site style-->
    <div class="form-block margin-top-20px height90">
    ...
    <div class="form-block margin-top-20px height150">
      ...
      <div class="form-text">
        <div class="text-field-wrap">
          <textarea class="editor" name="ckan.site_custom_css" rows="5" <?php print $this->isRequired('ckan_site_custom_css'); ?>><?php print $this->getDefault('ckan_site_custom_css'); ?></textarea>
          <div class="markdown">
            <span class="editor-info-block">You can use <a href="http://daringfireball.net/projects/markdown/syntax" target="_blank">Markdown formatting</a> here</span>
          </div>
        </div>
